    ...
    <div className="header d-flex align-items-center justify-content-space-between">
      <div className="header-left-items d-flex align-items-center mxy-30">
        <div className="menubar">
          ...
          >
            <g class="style-scope yt-icon pointer">
              <path
        ...
        <div className="logo">
          <a href="#">
            {" "}
            {/*} The link closes after the svg element*/}
            <svg
              viewBox="0 0 90 20"
              preserveAspectRatio="xMidYMid meet"
              focusable="false"
      ...
      <div className="header-middle-items d-flex align-items-center">
        <div className="input-box releative">
          <input
            type="text"
          ...
          {/*}Here it goes the volume button*/}
          <div className="voice-search">
            <svg
              viewBox="0 0 24 24"
              preserveAspectRatio="xMidYMid meet"
              focusable="false"
              class="style-scope yt-icon pointer absolute d-flex align-items-center justify-content-center"
      ...
      {/*}Header camera, right menu*/}
      <div className="header-final-items d-flex align-items-center">
        <div className="create-options">
          <svg
            viewBox="0 0 24 24"
            preserveAspectRatio="xMidYMid meet"
            focusable="false"
            class="style-scope yt-icon pointer mxy-15 d-flex align-items-center"
            style={{ width: "20px", height: "20px" }}
          >
            <g class="style-scope yt-icon">
              <path
        ...
        <div clasName="profile">
          <div clasName="profile-img">
            <img
              src="https://yt3.ggpht.com/yti/AHXOFjWGJAEan3OwPXxhUJjHcQoo3H4bR1A0AVtVdNAjig0=s88-c-k-c0x00ffffff-no-rj-mo"
              alt=""
              className="dp mxy-15 d-flex align-items-center"
              height="30"
              width="30"
            ></img>
          </div>
